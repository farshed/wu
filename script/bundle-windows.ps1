...
function BuildZedAndItsFriends {
    ...
    Copy-Item -Path ".\$CargoOutDir\edna.exe" -Destination "$innoDir\Edna.exe" -Force
...
function SignZedAndItsFriends {
    ...
    $files = "$innoDir\Edna.exe,$innoDir\cli.exe,$innoDir\auto_update_helper.exe,$innoDir\zed_explorer_command_injector.dll,$innoDir\zed_explorer_command_injector.appx"
...
function CollectFiles {
    ...
    Move-Item -Path "$innoDir\cli.exe" -Destination "$innoDir\bin\edna.exe" -Force
