...
The **Collaboration** toggle controls whether members can use Zed's real-time collaboration features, including Channels, shared projects, and voice chat. Collaboration is off by default for Business organizations.
...
- **Off:** Members must bring their own model access via LLM Providers or use External Agents for AI features.

## Edit Predictions

The **Edit Prediction** toggle controls whether members can use Zed's hosted Edit Predictions via the Zeta model family. Members using third-party providers or local models for edit predictions are not affected.
...
On Free and Pro, AI feedback and training data sharing is opt-in per member. On Business, it's off by default and controlled by the Agent Thread Feedback and Edit Prediction Feedback toggles above.
